========================================================================
    APPLICATION CONSOLE : Vue d'ensemble du projet TextureLBP_PascalCanuel
========================================================================

AppWizard a créé cette application TextureLBP_PascalCanuel pour vous.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application TextureLBP_PascalCanuel.


TextureLBP_PascalCanuel.vcxproj
...
TextureLBP_PascalCanuel.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) TextureLBP_PascalCanuel.pch et un fichier de type précompilé nommé StdAfx.obj.
